...
/***/ "./src/blocks/icon-boxes/components/edit.js":
/*!**************************************************!*\
  !*** ./src/blocks/icon-boxes/components/edit.js ***!
  \**************************************************/
...
/* harmony import */ var _styles_editor_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../styles/editor.scss */ "./src/blocks/icon-boxes/styles/editor.scss");
...
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../constants */ "./src/blocks/icon-boxes/constants.js");
/* harmony import */ var _inspector__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./inspector */ "./src/blocks/icon-boxes/components/inspector.js");
...
const ALLOWED_BLOCKS = ["rise-blocks/icon-box"];
const getCount = memize__WEBPACK_IMPORTED_MODULE_7___default()(count => {
  return lodash_times__WEBPACK_IMPORTED_MODULE_8___default()(count, () => ["rise-blocks/icon-box"]);
});
const Edit = props => {
  const {
    attributes,
  ...
  const wrapperClassName = classnames__WEBPACK_IMPORTED_MODULE_9___default()("wp-block-rise-blocks-icon-boxes", `${_constants__WEBPACK_IMPORTED_MODULE_6__.prefix}-items-per-row-${itemsPerRow}`, `${_constants__WEBPACK_IMPORTED_MODULE_6__.prefix}-${activeLayout}-layout`, {
...
/***/ "./src/blocks/icon-boxes/components/inspector.js":
/*!*******************************************************!*\
  !*** ./src/blocks/icon-boxes/components/inspector.js ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../constants */ "./src/blocks/icon-boxes/constants.js");
...
const InspectorPanel = ({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_6__.InspectorAdvancedControls, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_exporter__WEBPACK_IMPORTED_MODULE_10__["default"], {
    ...
    initialOpen: true
  }, (0,_helpers__WEBPACK_IMPORTED_MODULE_9__.shouldShowAddButton)(clientId) && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.Button, {
    className: `${_constants__WEBPACK_IMPORTED_MODULE_2__.prefix}-add-new-item`,
    isLarge: true,
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Add Icon Box", "rise-blocks"),
    icon: "insert",
    onClick: () => {
      const created = (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_4__.createBlock)("rise-blocks/icon-box");
      (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_5__.dispatch)("core/block-editor").insertBlock(created, undefined, clientId);
      setAttributes({
        count: count + 1
      });
    }
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Add New Icon Box", "rise-blocks")), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_layouts_icon__WEBPACK_IMPORTED_MODULE_7__["default"], {
    options: _constants__WEBPACK_IMPORTED_MODULE_8__.iconBoxLayout.layouts,
    ...
    value: itemsPerRow,
    onChange: newItemsPerRow => {
      (0,_helpers__WEBPACK_IMPORTED_MODULE_9__.setColWidth)(clientId, newItemsPerRow, gutter);
      setAttributes({
    ...
    checked: boxShadow,
    onChange: newBoxShadow => setAttributes({
    ...
    value: gutter,
    onChange: newGutter => {
      (0,_helpers__WEBPACK_IMPORTED_MODULE_9__.setColWidth)(clientId, itemsPerRow, newGutter);
      if (newGutter === 0) setAttributes({
        gutter: newGutter,
        boxShadow: false
      });else setAttributes({
        gutter: newGutter,
...
/***/ "./src/blocks/icon-boxes/components/save.js":
/*!**************************************************!*\
  !*** ./src/blocks/icon-boxes/components/save.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const Save = props => {
  ...
  const wrapperClassName = classnames__WEBPACK_IMPORTED_MODULE_3___default()("wp-block-rise-blocks-icon-boxes", `${_constants__WEBPACK_IMPORTED_MODULE_2__.prefix}-save`, `${_constants__WEBPACK_IMPORTED_MODULE_2__.prefix}-${activeLayout}-layout`, {
...
/***/ "./src/blocks/icon-boxes/constants.js":
/*!********************************************!*\
  !*** ./src/blocks/icon-boxes/constants.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   iconBoxLayout: () => (/* binding */ iconBoxLayout)
/* harmony export */ });
...
const {
  ...
  center,
  right
} = _helpers_svg__WEBPACK_IMPORTED_MODULE_0__["default"].iconBoxPro.aligns;
const iconBoxLayout = {
  active: 'center',
  layouts: [{
    name: 'left',
...
const editorAttrs = {
  isInit: false,
  boxShadow: true,
  activeLayout: iconBoxLayout.active,
  count: 3
};
...
/***/ "./src/blocks/icon-boxes/index.js":
/*!****************************************!*\
  !*** ./src/blocks/icon-boxes/index.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _styles_style_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styles/style.scss */ "./src/blocks/icon-boxes/styles/style.scss");
...
/* harmony import */ var _components_save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/save */ "./src/blocks/icon-boxes/components/save.js");
/* harmony import */ var _components_edit__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/edit */ "./src/blocks/icon-boxes/components/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./block.json */ "./src/blocks/icon-boxes/block.json");
...
/***/ "./src/blocks/icon-boxes/styles/editor.scss":
/*!**************************************************!*\
  !*** ./src/blocks/icon-boxes/styles/editor.scss ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/blocks/icon-boxes/styles/style.scss":
/*!*************************************************!*\
  !*** ./src/blocks/icon-boxes/styles/style.scss ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/blocks/icon-boxes/block.json":
/*!******************************************!*\
  !*** ./src/blocks/icon-boxes/block.json ***!
  \******************************************/
/***/ ((module) => {
...
"use strict";
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"rise-blocks/icon-boxes","keywords":["icon boxes"],"version":"3.1.1","title":"Icon Boxes","category":"rise-blocks","description":"This block enables you to display information along with Icon and show it either in grid or in a row.","example":{"name":"rise-blocks/icon-boxes","attributes":{"isInit":true,"count":3,"boxShadow":true,"activeLayout":"center","itemsPerRow":2,"gutter":31},"innerBlocks":[{"name":"rise-blocks/icon-box","attributes":{"isInit":true,"titleTag":"2","alignment":"center","wrapperLink":"","wrapperTarget":true,"isImageIcon":false,"image":{"url":""},"imageRadius":0,"imageWidth":{"activeUnit":"px","units":["px"],"range":{"min":1,"max":3000},"values":{"desktop":null,"tablet":null,"mobile":null}},"gutter":30,"selectedIcon":{"icon":"fa-facebook","page":2},"activeIconLayout":"frame","titleTypo":{"fontFamily":"","fontSize":{"units":["px","em","rem"],"activeUnit":"px","values":{"desktop":24,"tablet":24,"mobile":24}},"fontWeight":600,"lineHeight":{"activeUnit":"","units":[""],"values":{"desktop":1.6,"tablet":1.6,"mobile":1.6}}},"contentTypo":{"fontFamily":"","fontSize":{"units":["px","em","rem"],"activeUnit":"px","values":{"desktop":15,"tablet":15,"mobile":15}},"fontWeight":400,"lineHeight":{"activeUnit":"","units":[""],"values":{"desktop":1.5,"tablet":1.5,"mobile":1.5}}},"iconBorderWidth":2,"iconsBoxSize":{"activeUnit":"px","units":["px"],"range":{"min":10,"max":200},"values":{"desktop":80,"tablet":80,"mobile":80}},"iconSize":{"activeUnit":"px","units":["px"],"range":{"min":10,"max":200},"values":{"desktop":40,"tablet":40,"mobile":40}},"boxPadding":{"responsiveViews":["desktop","tablet","mobile"],"units":["px","em","rem"],"activeUnit":"px","isLinkActive":false,"values":{"desktop":[60,35,60,35],"tablet":[60,35,60,35],"mobile":[60,35,60,35]}},"headingPadding":{"responsiveViews":["desktop","tablet","mobile"],"units":["px","em","rem"],"activeUnit":"px","isLinkActive":false,"values":{"desktop":[30,0,15,0],"tablet":[30,0,15,0],"mobile":[30,0,15,0]}},"titleColor":"#000","contentColor":"#000","iconColors":{"initial":{"color":"#000000"},"frame":{"borderColor":"#000000","color":"#000000"},"stack":{"backgroundColor":"#000000","color":"#fff"}},"title":"Facebook","content":"Connect with us here."}},{"name":"rise-blocks/icon-box","attributes":{"isInit":true,"titleTag":"2","alignment":"center","wrapperLink":"","wrapperTarget":true,"isImageIcon":false,"image":{"url":""},"imageRadius":0,"imageWidth":{"activeUnit":"px","units":["px"],"range":{"min":1,"max":3000},"values":{"desktop":null,"tablet":null,"mobile":null}},"gutter":30,"selectedIcon":{"icon":"fa-instagram","page":2},"activeIconLayout":"frame","titleTypo":{"fontFamily":"","fontSize":{"units":["px","em","rem"],"activeUnit":"px","values":{"desktop":24,"tablet":24,"mobile":24}},"fontWeight":600,"lineHeight":{"activeUnit":"","units":[""],"values":{"desktop":1.6,"tablet":1.6,"mobile":1.6}}},"contentTypo":{"fontFamily":"","fontSize":{"units":["px","em","rem"],"activeUnit":"px","values":{"desktop":15,"tablet":15,"mobile":15}},"fontWeight":400,"lineHeight":{"activeUnit":"","units":[""],"values":{"desktop":1.5,"tablet":1.5,"mobile":1.5}}},"iconBorderWidth":2,"iconsBoxSize":{"activeUnit":"px","units":["px"],"range":{"min":10,"max":200},"values":{"desktop":80,"tablet":80,"mobile":80}},"iconSize":{"activeUnit":"px","units":["px"],"range":{"min":10,"max":200},"values":{"desktop":40,"tablet":40,"mobile":40}},"boxPadding":{"responsiveViews":["desktop","tablet","mobile"],"units":["px","em","rem"],"activeUnit":"px","isLinkActive":false,"values":{"desktop":[60,35,60,35],"tablet":[60,35,60,35],"mobile":[60,35,60,35]}},"headingPadding":{"responsiveViews":["desktop","tablet","mobile"],"units":["px","em","rem"],"activeUnit":"px","isLinkActive":false,"values":{"desktop":[30,0,15,0],"tablet":[30,0,15,0],"mobile":[30,0,15,0]}},"titleColor":"#000","contentColor":"#000","iconColors":{"initial":{"color":"#000000"},"frame":{"borderColor":"#000000","color":"#000000"},"stack":{"backgroundColor":"#000000","color":"#fff"}},"title":"Instagram","content":"Connect with us here."}}]},"attributes":{"isInit":{"type":"boolean","default":false},"count":{"type":"number","default":3},"boxShadow":{"type":"boolean","default":true},"activeLayout":{"type":"string","default":"center"},"block_id":{"type":"string"},"itemsPerRow":{"type":"number"},"gutter":{"type":"number"}},"textdomain":"rise-blocks","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
...
/******/ 		var installedChunks = {
/******/ 			"blocks/icon-boxes/index": 0,
/******/ 			"blocks/icon-boxes/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["blocks/icon-boxes/style-index"], () => (__webpack_require__("./src/blocks/icon-boxes/index.js")))
