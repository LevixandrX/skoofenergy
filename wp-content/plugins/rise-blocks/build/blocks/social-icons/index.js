...
/***/ "./src/blocks/social-icons/components/edit.js":
/*!****************************************************!*\
  !*** ./src/blocks/social-icons/components/edit.js ***!
  \****************************************************/
...
/* harmony import */ var _styles_editor_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../styles/editor.scss */ "./src/blocks/social-icons/styles/editor.scss");
...
/* harmony import */ var _inspector__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./inspector */ "./src/blocks/social-icons/components/inspector.js");
/* harmony import */ var _components_parent_block_selector__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../components/parent-block-selector */ "./src/components/parent-block-selector.js");
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../helpers */ "./src/helpers/index.js");
/* harmony import */ var memize__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! memize */ "./node_modules/memize/index.js");
/* harmony import */ var memize__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(memize__WEBPACK_IMPORTED_MODULE_11__);
...
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../constants */ "./src/blocks/social-icons/constants.js");
...
const singleBlock = "rise-blocks/social-icon";
const ALLOWED_BLOCKS = [singleBlock];
const getCount = memize__WEBPACK_IMPORTED_MODULE_11___default()(count => {
  return lodash_times__WEBPACK_IMPORTED_MODULE_12___default()(count, () => [singleBlock, _constants__WEBPACK_IMPORTED_MODULE_13__.defaultAttrs]);
});
const Edit = props => {
  const {
    clientId,
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useEffect)(() => {
    setAttributes({
      block_id: `${_constants__WEBPACK_IMPORTED_MODULE_7__.prefix}-${props.className}-${props.instanceId}-${clientId}`
    });
  }, []);
  const blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_6__.useBlockProps)({
    style: {
      ...(0,_helpers__WEBPACK_IMPORTED_MODULE_10__.getDimensionStyle)(["paddingTop", "paddingRight", "paddingBottom", "paddingLeft"], margin)
    },
    className: ` ${_constants__WEBPACK_IMPORTED_MODULE_7__.prefix}-social-align-${alignment}`
  });
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_inspector__WEBPACK_IMPORTED_MODULE_8__["default"], {
    ...
    ...blockProps
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_parent_block_selector__WEBPACK_IMPORTED_MODULE_9__["default"], {
    icon: "socialIcons",
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Social Icons", "rise-blocks")
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_6__.InnerBlocks, {
    template: getCount(1),
    allowedBlocks: ALLOWED_BLOCKS
  })));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_5__.withInstanceId)(Edit));

/***/ }),

/***/ "./src/blocks/social-icons/components/inspector.js":
/*!*********************************************************!*\
  !*** ./src/blocks/social-icons/components/inspector.js ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../constants */ "./src/blocks/social-icons/constants.js");
...
const InspectorPanel = props => {
  ...
  const updateChild = attrs => {
    const inner = (0,_helpers__WEBPACK_IMPORTED_MODULE_8__.getInnerBlocks)(clientId);
    inner.forEach(b => {
      (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.dispatch)("core/block-editor").updateBlockAttributes(b.clientId, attrs);
    });
  };
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.InspectorAdvancedControls, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_exporter__WEBPACK_IMPORTED_MODULE_10__["default"], {
    ...
    initialOpen: true
  }, (0,_helpers__WEBPACK_IMPORTED_MODULE_8__.shouldShowAddButton)(clientId) && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.Button, {
    className: `${_constants__WEBPACK_IMPORTED_MODULE_2__.prefix}-add-new-item`,
    isLarge: true,
    icon: "insert",
    onClick: () => {
      const created = (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_11__.createBlock)(singleBlock, {
        size,
        radius,
        fontSize
      });
      (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.dispatch)("core/block-editor").insertBlock(created, undefined, clientId);
    }
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Add New Social Icon", "rise-blocks")), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.RangeControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Size", "rise-blocks"),
    value: size,
    initialPosition: _constants__WEBPACK_IMPORTED_MODULE_9__.defaultAttrs.size,
    defaultValue: _constants__WEBPACK_IMPORTED_MODULE_9__.defaultAttrs.size,
    onChange: newSize => {
      if (typeof newSize === "undefined") {
        newSize = _constants__WEBPACK_IMPORTED_MODULE_9__.defaultAttrs.size;
      }
      setAttributes({
        size: newSize
      });
    ...
    min: 20,
    max: 80
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_custom_control__WEBPACK_IMPORTED_MODULE_6__.FontSizeControl, {
    value: fontSize,
    initialPosition: _constants__WEBPACK_IMPORTED_MODULE_9__.defaultAttrs.fontSize,
    defaultValue: _constants__WEBPACK_IMPORTED_MODULE_9__.defaultAttrs.fontSize,
    onChange: newFontSize => {
      if (typeof newFontSize === "undefined") {
        newFontSize = _constants__WEBPACK_IMPORTED_MODULE_9__.defaultAttrs.fontSize;
      }
      setAttributes({
  ...
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_custom_control__WEBPACK_IMPORTED_MODULE_6__.RadiusControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Radius", "rise-blocks"),
    value: radius,
    initialPosition: _constants__WEBPACK_IMPORTED_MODULE_9__.defaultAttrs.radius,
    defaultValue: _constants__WEBPACK_IMPORTED_MODULE_9__.defaultAttrs.radius,
    onChange: newRadius => {
      if (typeof newRadius === "undefined") {
        newRadius = _constants__WEBPACK_IMPORTED_MODULE_9__.defaultAttrs.radius;
      }
      setAttributes({
        radius: newRadius
      });
    ...
    defaultValue: _constants__WEBPACK_IMPORTED_MODULE_9__.defaultAttrs.margin,
    value: margin,
...
/***/ "./src/blocks/social-icons/components/save.js":
/*!****************************************************!*\
  !*** ./src/blocks/social-icons/components/save.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const Save = props => {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: `${_constants__WEBPACK_IMPORTED_MODULE_2__.prefix}-social-align-${alignment}`
...
/***/ "./src/blocks/social-icons/constants.js":
/*!**********************************************!*\
  !*** ./src/blocks/social-icons/constants.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _styles_style_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styles/style.scss */ "./src/blocks/social-icons/styles/style.scss");
...
/* harmony import */ var _components_edit__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/edit */ "./src/blocks/social-icons/components/edit.js");
/* harmony import */ var _components_save__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/save */ "./src/blocks/social-icons/components/save.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./block.json */ "./src/blocks/social-icons/block.json");
...
(0,_helpers___WEBPACK_IMPORTED_MODULE_1__.register)(_block_json__WEBPACK_IMPORTED_MODULE_5__.name, {
  icon: _helpers_svg__WEBPACK_IMPORTED_MODULE_2__["default"].socialIcons,
...
/***/ "./src/blocks/social-icons/styles/editor.scss":
/*!****************************************************!*\
  !*** ./src/blocks/social-icons/styles/editor.scss ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/blocks/social-icons/styles/style.scss":
/*!***************************************************!*\
  !*** ./src/blocks/social-icons/styles/style.scss ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/blocks/social-icons/block.json":
/*!********************************************!*\
  !*** ./src/blocks/social-icons/block.json ***!
  \********************************************/
/***/ ((module) => {
...
"use strict";
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"rise-blocks/social-icons","keywords":["social icons"],"version":"3.1.1","title":"Social Icons","category":"rise-blocks","description":"This block enables you to display social icons and set a link to each icon to the relevant social profile with different design options.","supports":{"className":false},"example":{"name":"rise-blocks/social-icons","attributes":{"fontSize":25,"size":45,"alignment":"center","radius":0,"margin":{"activeUnit":"px","units":["px","em"],"isLinkActive":true,"range":{"min":10,"max":300},"values":{"desktop":[0,0,0,0],"tablet":[0,0,0,0],"mobile":[0,0,0,0]}}},"innerBlocks":[{"name":"rise-blocks/social-icon","attributes":{"link":"","icon":{"icon":"fa-facebook","page":1},"size":45,"background":"#0693e3","color":"#ffffff","radius":0}},{"name":"rise-blocks/social-icon","attributes":{"link":"#","icon":{"icon":"fa-instagram","page":1},"size":45,"background":"#cd5bfc","color":"#ffffff","radius":0}},{"name":"rise-blocks/social-icon","attributes":{"link":"#","icon":{"icon":"fa-pinterest-p","page":1},"size":45,"background":"#e30707","color":"#ffffff","radius":0}}]},"attributes":{"block_id":{"type":"string"},"fontSize":{"type":"number","default":25},"size":{"type":"number","default":45},"alignment":{"type":"string","default":"left"},"radius":{"type":"number","default":0},"margin":{"type":"object","default":{"activeUnit":"px","units":["px","em"],"isLinkActive":true,"range":{"min":10,"max":300},"values":{"desktop":[0,0,0,0],"tablet":[0,0,0,0],"mobile":[0,0,0,0]}}}},"textdomain":"rise-blocks","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
...
/******/ 		var installedChunks = {
/******/ 			"blocks/social-icons/index": 0,
/******/ 			"blocks/social-icons/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["blocks/social-icons/style-index"], () => (__webpack_require__("./src/blocks/social-icons/index.js")))
