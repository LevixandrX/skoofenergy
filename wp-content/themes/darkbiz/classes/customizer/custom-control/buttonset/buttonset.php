<?php
/**
 * Customizer Control: darkbiz-buttonset.
 *
 * @since   1.0.0
 *
...
if ( class_exists( 'WP_Customize_Control' ) ){
	class Darkbiz_Customizer_Buttonset_Control extends WP_Customize_Control {
		...
		protected function content_template() {
			...
			<# } #>
			<div id="input_{{ data.id }}" class="darkbiz-buttonset">
...
Darkbiz_Customizer::add_custom_control( array(
    ...
    'class'    => 'Darkbiz_Customizer_Buttonset_Control',
