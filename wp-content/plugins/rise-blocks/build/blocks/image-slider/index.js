...
/***/ "./src/blocks/image-slider/components/edit.js":
/*!****************************************************!*\
  !*** ./src/blocks/image-slider/components/edit.js ***!
  \****************************************************/
...
/* harmony import */ var _styles_editor_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../styles/editor.scss */ "./src/blocks/image-slider/styles/editor.scss");
...
/* harmony import */ var _inspector__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./inspector */ "./src/blocks/image-slider/components/inspector.js");
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../constants */ "./src/constants.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../block.json */ "./src/blocks/image-slider/block.json");
...
const Edit = props => {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_5__.useEffect)(() => {
    setAttributes({
      block_id: `${_constants__WEBPACK_IMPORTED_MODULE_9__.prefix}-image-slider-block-instance-${instanceId}-${clientId}`
    });
  }, []);
  const sliderRef = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_5__.useRef)(null);
  const Next = () => {
  ...
  const toShow = slideToShow.length === 0 ? _block_json__WEBPACK_IMPORTED_MODULE_10__.attributes.slideToShow["default"].values.desktop : slideToShow.values.desktop;
  let show = 1;
  if (image) {
    show = image.length < toShow ? image.length : toShow;
  }
  const settings = {
    slidesToShow: show,
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_inspector__WEBPACK_IMPORTED_MODULE_8__["default"], {
    ...
    ...blockProps
  }, !image && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.Placeholder, {
    icon: "admin-post",
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Slider", "rise-blocks")
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Add Slider.", "rise-blocks")), image && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_slick__WEBPACK_IMPORTED_MODULE_6__["default"], {
    ref: sliderRef,
    ...settings
  }, image.map((i, k) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "rise-blocks-image-slider",
    key: k
...
/***/ "./src/blocks/image-slider/components/inspector.js":
/*!*********************************************************!*\
  !*** ./src/blocks/image-slider/components/inspector.js ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _custom_control_responsive_range_wrapper__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../custom-control/responsive-range-wrapper */ "./src/custom-control/responsive-range-wrapper.js");
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../block.json */ "./src/blocks/image-slider/block.json");
...
const InspectorPanel = props => {
  ...
  const onRender = ({
    ...
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      ...
      onClick: open,
      className: `${_constants__WEBPACK_IMPORTED_MODULE_4__.prefix}-image-uploader-trigger components-button is-primary`
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Add Images", "rise-blocks")));
  };
  const onSelect = v => {
    const pushLink = d => {
      d.wrapper_link = d.caption;
      return d;
    };
    setAttributes({
      image: v.map(v => pushLink(v))
    });
  };
  let selected = [];
  if (!(0,_helpers__WEBPACK_IMPORTED_MODULE_3__.isUndefined)(image)) {
    selected = image.map(i => i.id);
  }
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_7__.InspectorAdvancedControls, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_exporter__WEBPACK_IMPORTED_MODULE_6__["default"], {
    clientId: clientId
  })), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_7__.InspectorControls, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_8__.PanelBody, {
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Image", "rise-blocks"),
    initialOpen: true
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_7__.MediaUploadCheck, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_7__.MediaUpload, {
    gallery: false,
    multiple: true,
    onSelect: onSelect,
    allowedTypes: ["image"],
    ...
    defaultValue: _block_json__WEBPACK_IMPORTED_MODULE_5__.attributes.slideToShow["default"],
    value: slideToShow,
    onChange: slideToShow => setAttributes({
      slideToShow
    }),
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Slide To Show", "rise-blocks"),
    beforeIcon: ""
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_8__.TextControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Slide To Scroll", "rise-blocks"),
    type: "number",
    value: slideToScroll,
    max: selected.length,
    onChange: slideToScroll => {
      setAttributes({
        slideToScroll: parseInt(slideToScroll)
      });
    }
    ...
    defaultValue: _block_json__WEBPACK_IMPORTED_MODULE_5__.attributes.height["default"],
    value: height,
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _styles_style_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styles/style.scss */ "./src/blocks/image-slider/styles/style.scss");
/* harmony import */ var _components_edit__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/edit */ "./src/blocks/image-slider/components/edit.js");
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block.json */ "./src/blocks/image-slider/block.json");
/*----------------------------------------------------------------------------------------------------------------------------*
 *                       									                                                                  *
...
/***/ "./src/blocks/image-slider/styles/editor.scss":
/*!****************************************************!*\
  !*** ./src/blocks/image-slider/styles/editor.scss ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/blocks/image-slider/styles/style.scss":
/*!***************************************************!*\
  !*** ./src/blocks/image-slider/styles/style.scss ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"rise-blocks/image-slider","keywords":["slider","image"],"version":"3.1.1","title":"Image Slider","category":"rise-blocks","description":"","supports":{"html":false},"example":{"name":"rise-blocks/image-slider","attributes":{"block_id":"rise-blocks-image-slider-instance-0","image":[{"url":"https://get.pxhere.com/photo/landscape-tree-horizon-silhouette-light-cloud-sky-sun-sunrise-sunset-skyline-sunlight-morning-building-dawn-city-atmosphere-cityscape-dusk-evening-contrast-background-image-clouds-of-background-madrid-landscapes-wallpaper-clams-afterglow-removal-human-settlement-1119150.jpg"}],"slideToShow":{"activeUnit":"","units":[],"values":{"desktop":1,"tablet":3,"mobile":2}},"slideToScroll":1,"enableAutoPlay":false,"enableDots":false,"enableArrows":false,"height":{"activeUnit":"px","units":["px"],"values":{"desktop":250,"tablet":250,"mobile":250}}}},"attributes":{"block_id":{"type":"string"},"image":{"type":"array"},"slideToShow":{"type":"object","default":{"activeUnit":"","units":[],"range":{"min":1,"max":12},"values":{"desktop":5,"tablet":3,"mobile":2}}},"slideToScroll":{"type":"number","default":1},"enableAutoPlay":{"type":"boolean","default":false},"enableDots":{"type":"boolean","default":false},"enableArrows":{"type":"boolean","default":false},"height":{"type":"object","default":{"activeUnit":"px","units":["px"],"range":{"min":100,"max":1000},"values":{"desktop":250,"tablet":250,"mobile":250}}}},"textdomain":"rise-blocks","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
