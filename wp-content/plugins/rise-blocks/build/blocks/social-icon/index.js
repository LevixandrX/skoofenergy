...
/***/ "./src/blocks/social-icon/components/edit.js":
/*!***************************************************!*\
  !*** ./src/blocks/social-icon/components/edit.js ***!
  \***************************************************/
...
/* harmony import */ var _inspector__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./inspector */ "./src/blocks/social-icon/components/inspector.js");
...
const Edit = props => {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useEffect)(() => {
    setAttributes({
      block_id: `${_constants__WEBPACK_IMPORTED_MODULE_7__.prefix}-social-icon-instance-${instanceId}-${clientId}`
    });
  }, []);
  const style = {
    color,
  ...
  if (clientId != null && (0,_helpers__WEBPACK_IMPORTED_MODULE_9__.shouldShowUpgrader)(clientId)) {
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: `${_constants__WEBPACK_IMPORTED_MODULE_7__.prefix}-social-icon`
  ...
  const blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_5__.useBlockProps)({
    className: `${_constants__WEBPACK_IMPORTED_MODULE_7__.prefix}-social-icon-wrapper`
  });
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_inspector__WEBPACK_IMPORTED_MODULE_8__["default"], {
    ...
    href: (0,_wordpress_url__WEBPACK_IMPORTED_MODULE_4__.prependHTTP)(link),
...
/***/ "./src/blocks/social-icon/components/inspector.js":
/*!********************************************************!*\
  !*** ./src/blocks/social-icon/components/inspector.js ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _custom_control_icon_selector__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../custom-control/icon-selector */ "./src/custom-control/icon-selector.js");
...
const InspectorPanel = props => {
  ...
  const colorSettings = [{
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Color", "rise-blocks"),
    value: color,
    onChange: newColor => setAttributes({
      color: newColor
    })
  }, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Background", "rise-blocks"),
    value: background,
    onChange: newBackground => setAttributes({
  ...
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_custom_control_icon_selector__WEBPACK_IMPORTED_MODULE_4__["default"], {
    value: icon,
    icons: _constants__WEBPACK_IMPORTED_MODULE_5__.faSocialIcons,
    prefix: "fa",
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Select an Icon", "rise-blocks"),
    onChange: newIcon => setAttributes({
      icon: newIcon
    })
  })), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_custom_control__WEBPACK_IMPORTED_MODULE_6__.LinkControl, {
    value: link,
    onChange: newLink => {
      setAttributes({
        link: newLink
...
/***/ "./src/blocks/social-icon/components/save.js":
/*!***************************************************!*\
  !*** ./src/blocks/social-icon/components/save.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const Save = ({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: `${_constants__WEBPACK_IMPORTED_MODULE_3__.prefix}-social-icon-wrapper`
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    href: (0,_wordpress_url__WEBPACK_IMPORTED_MODULE_1__.prependHTTP)(link),
...
/***/ "./src/blocks/social-icon/block.json":
/*!*******************************************!*\
  !*** ./src/blocks/social-icon/block.json ***!
  \*******************************************/
/***/ ((module) => {
...
"use strict";
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"rise-blocks/social-icon","keywords":["social icon"],"version":"3.1.1","title":"Social Icon","category":"rise-blocks","description":"This block enables you to display social icons and set a link to each icon to the relevant social profile with different design options.","supports":{"className":false,"inserter":false},"attributes":{"block_id":{"type":"string"},"link":{"type":"string","default":"#"},"icon":{"type":"object","default":{"icon":"fa-facebook","page":1}},"size":{"type":"number"},"background":{"type":"string","default":"#0693e3"},"color":{"type":"string","default":"#ffffff"},"radius":{"type":"number"}},"textdomain":"rise-blocks","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
...
/* harmony import */ var _components_edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/edit */ "./src/blocks/social-icon/components/edit.js");
/* harmony import */ var _components_save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/save */ "./src/blocks/social-icon/components/save.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block.json */ "./src/blocks/social-icon/block.json");





(0,_helpers__WEBPACK_IMPORTED_MODULE_0__.register)(_block_json__WEBPACK_IMPORTED_MODULE_4__.name, {
  parent: ['rise-blocks/social-icons'],
  icon: _helpers_svg__WEBPACK_IMPORTED_MODULE_1__["default"].socialIcons,
